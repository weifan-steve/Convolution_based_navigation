...
/************************************************************************************
FUNCTION		:Led_Status_display
DESCRIPTION		:To indicate the MCU status 
INPUT			:void
OUTPUT			:None
UPDATE			:2022/11/17
*************************************************************************************/
...
DESCRIPTION		:upload the status to PC in a given thresold 
INPUT			:upload interval 
OUTPUT			:None
UPDATE			:2022/11/17
*************************************************************************************/
void upload_status_to_pc(int interval) {
	upload_tick++;
	if (upload_tick > interval) {
		uart_Data2PC();
		upload_tick = 0; 
	}
}
...
float original_profile(index, split_point1, split_point2) {
	...
	else if (index <= split_point2) {
		return agv_constraint.v_f - agv_constraint.v_s;
	}
	else {
		return 0;
	}
...
UPDATE			:2023/2/18
*************************************************************************************/
void travel_one_section(int section_count) {
